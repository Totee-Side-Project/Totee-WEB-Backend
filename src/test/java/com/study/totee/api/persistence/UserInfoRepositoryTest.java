...
public class UserInfoRepositoryTest {
    ...
    public void 유저정보_등록() {
        ...
        final UserInfoEntity userInfoEntity = UserInfoEntity.builder()
                .nickname("TEST")
                .positionList(null)
        ...
        // when
        final UserInfoEntity savedUserInfoEntity = userInfoRepository.save(userInfoEntity);

        // then
        assertThat(savedUserInfoEntity.getUserInfoId()).isNotNull();
    ...
    public void 유저정보_닉네임조회() {
        ...
        // when
        final UserInfoEntity foundUserInfoEntity = userInfoRepository.findByNickname("TEST");
    ...
    public void 유저정보_닉네임수정() {
        // given
        UserInfoEntity foundUserInfoEntity = userInfoRepository.findByNickname("TEST");
    ...
    public void 유저정보_삭제() {
        // given
        UserInfoEntity foundUserInfoEntity = userInfoRepository.findByNickname("nTest");
