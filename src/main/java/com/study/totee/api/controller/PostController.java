...
public class PostController {
    ...
    @ApiOperation(value = "스터디 게시물 제목 검색합니다.", notes = "제목에 해당하는 게시글을 조회합니다. 빈 검색어 보내면 안됩니다")
    ...
    @ApiOperation(value = "추천 스터디 게시물 목록 불러오기", notes = "로그인한 유저의 포지션과 등록된 게시글의 모집분야가 같은 글을 조회합니다.")
    ...
    @ApiOperation(value = "스터디 게시글 상세보기",
            notes = "PostId로 상세보기\n" +
    ...
    @ApiOperation(value = "스터디 모집완료 수정", notes = "스터디 모집 중일 때 모집완료, 모집완료 일 때 모집 중으로 변환")
    ...
    public ApiResponse<Object> updateStatus(@AuthenticationPrincipal org.springframework.security.core.userdetails.User principal , @PathVariable Long postId) {
        ...
        return ApiResponse.success("data", "모집 상태가 변경되었습니다.");
    }
}
